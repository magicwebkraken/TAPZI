    ...
    52775: (e, t, s) => {
      ...
      var c = s(50920),
        ...
        y = class {
          ...
          #c;
          constructor(e = {}) {
            (this.#r = e.queryCache || new u()),
              (this.#a = e.mutationCache || new h()),
          ...
          setMutationDefaults(e, t) {
            this.#l.set((0, i.EN)(e), { mutationKey: e, defaultOptions: t });
          }
          ...
          onFetch: (t, s) => {
            let r = t.options,
              ...
              f = async () => {
                ...
                if (u && l.length) {
                  let e = "backward" === u,
                    t = { pages: l, pageParams: h },
                    s = (e ? n : a)(r, t);
                  o = await y(t, s, e);
                } else {
                  let t = e ?? l.length;
                  do {
                    let e = 0 === c ? h[0] ?? r.initialPageParam : a(r, o);
                    if (c > 0 && null == e) break;
                    (o = await y(o, e)), c++;
                  } while (c < t);
                }
