    ...
    27677: (e, t, i) => {
              ...
              return (
                !u &&
                  ...
                  ((u = l.match(/(Version)\/([\d.]+)/)) ||
                    (u = [0, 1, "13_0_0"]),
                  (m = !1)),
                p && "Win32" !== r && ((a.os = "android"), (a.android = !0)),
      ...
      function b(e) {
        let t,
          ...
          { params: l, touches: a, rtlTranslate: d, enabled: c } = this;
                ...
                r.currentTranslate >
                  (l.centeredSlides
                    ? this.minTranslate() -
                      ...
                      this.slides.length - l.slidesPerView >= 2
                        ? this.slidesSizesGrid[this.activeIndex + 1] +
      ...
      function T(e) {
        ...
        if (h > a.longSwipesMs) {
          ...
          "next" === s.swipeDirection &&
            (S >= a.longSwipesRatio
              ? s.slideTo(a.rewind && s.isEnd ? g : m + b)
              : s.slideTo(m)),
            "prev" === s.swipeDirection &&
              (S > 1 - a.longSwipesRatio
                ? s.slideTo(m + b)
                : null !== w && S < 0 && Math.abs(S) > a.longSwipesRatio
                ? s.slideTo(w)
                : s.slideTo(m));
        } else {
      ...
      let L = {
          ...
          update: {
            ...
            updateSlides: function () {
              ...
              for (let r = 0; r < h; r += 1) {
                ...
                if (
                  ((e = 0),
                  u[r] && (l = u[r]),
                  C && t.grid.updateSlide(r, l, u),
                  !u[r] || "none" !== (0, o.q)(l, "display"))
                ) {
            ...
            updateSlidesClasses: function () {
              let e,
                t,
                i,
                { slides: s, params: r, slidesEl: l, activeIndex: a } = this,
                n = this.virtual && r.virtual.enabled,
                d = this.grid && r.grid && r.grid.rows > 1,
                c = (e) =>
                  (0, o.e)(l, `.${r.slideClass}${e}, swiper-slide${e}`)[0];
              if (n)
                if (r.loop) {
            ...
            updateActiveIndex: function (e) {
              ...
              if (
                (t >= l.length && (t = l.length - 1), c === n && !s.params.loop)
              ) {
              ...
              if (s.virtual && a.virtual.enabled && a.loop) i = p(c);
              else if (u) {
          ...
          slide: {
            slideTo: function (e, t, i, s, r) {
              ...
              let w = Math.min(a.params.slidesPerGroupSkip, n),
              ...
              if (
                !(T && r) &&
                ((m && -b === a.translate) || (!m && b === a.translate))
              )
                return (
              ...
              let y = p().isSafari;
              return (
                T && !r && y && a.isElement && a.virtual.update(!1, !1, n),
                a.setTransition(t),
                a.setTranslate(b),
                a.updateActiveIndex(n),
                a.updateSlidesClasses(),
          ...
          loop: {
            ...
            loopFix: function (e) {
              ...
              b % S != 0 && (b += S - (b % S)),
                (c.loopedSlides = b += m.loopAdditionalSlides);
              let T = c.grid && m.grid && m.grid.rows > 1;
              p.length < w + b ||
              ("cards" === c.params.effect && p.length < w + 2 * b)
                ? (0, o.v)(
              ...
              void 0 === l
                ? (l = c.getSlideIndex(
                    p.find((e) => e.classList.contains(m.slideActiveClass))
                  ))
                : (M = l);
              let P = "next" === s || !s,
                k = "prev" === s || !s,
              ...
              if (_ < b) {
                ...
                (L = Math.max(_ - (x - 2 * b), S)),
                  C && (L = Math.max(L, w - x + g + 1));
                for (let e = 0; e < L; e += 1) {
                  let t = e - Math.floor(e / x) * x;
                  T
                    ? p.forEach((e, i) => {
              ...
              if (
                ...
                "cards" === c.params.effect &&
                  p.length < w + 2 * b &&
                  (E.includes(l) && E.splice(E.indexOf(l), 1),
                  y.includes(l) && y.splice(y.indexOf(l), 1)),
                k &&
                  y.forEach((e) => {
      ...
      class I {
        ...
        slidesPerViewDynamic(e, t) {
          ...
          else for (let e = n - 1; e >= 0; e -= 1) r[n] - r[e] < a && (o += 1);
          return o;
        }
        update() {
          let e,
        ...
        I.use([
          ...
          function (e) {
            let { swiper: t, extendParams: i, on: s, emit: r } = e,
              ...
              d = function (e, i) {
                void 0 === i && (i = {});
                let s = new (a.MutationObserver || a.WebkitMutationObserver)(
                  (e) => {
          ...
          let {
            ...
            M = (0, a.useRef)(null),
            {
              ...
              let i = { on: {} },
                s = {},
                r = {};
              D(i, O), (i._emitClasses = !0), (i.init = !1);
              let l = {},
                a = A.map((e) => e.replace(/_/, ""));
              return (
                ...
                e.length &&
                  ...
                  (function (e) {
                    ...
                    h.includes("loop") &&
                      ...
                      h.includes("children") && p && E && S.virtual.enabled
                        ? ((E.slides = p), E.update(!0))
                        : h.includes("virtual") &&
                          E &&
                          S.virtual.enabled &&
                          (p && (E.slides = p), E.update(!0)),
                      h.includes("children") && p && S.loop && (d = !0),
                      t && x.init() && x.update(!0),
          ...
          u = () => {
            ...
            let e =
              ...
              (0.5 -
                ...
                (r - n);
            if (
              (p(e, r) && (e = r), i.wrapperEl.scrollTo({ [l]: e }), p(e, r))
            ) {
        ...
        function p() {
          ...
          let p = (e, i) => {
            e && e.addEventListener("click", "next" === i ? c : d),
              !t.enabled && e && e.classList.add(...l.lockClass.split(" "));
          };
          n.forEach((e) => p(e, "next")), o.forEach((e) => p(e, "prev"));
        }
        function u() {
          let { nextEl: e, prevEl: i } = t.navigation;
          (e = (0, s.m)(e)), (i = (0, s.m)(i));
