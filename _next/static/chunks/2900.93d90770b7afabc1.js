  ...
  [2900],
  {
    52900: (t, e, i) => {
      ...
      let B = new Set([
        ...
        q = (t) => (e) => e.test(t),
        _ = [I, z, Y, W, X, H, { test: (t) => "auto" === t, parse: (t) => t }],
        G = (t) => _.find(q(t)),
        Z = () => {},
        J = () => {},
        Q = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t),
        ...
        t$ = {
          test: function (t) {
            return (
              isNaN(t) &&
              "string" == typeof t &&
              (t.match(tb)?.length || 0) + (t.match(tj)?.length || 0) > 0
            );
          },
          parse: tI,
      ...
      class ew {
        ...
        update(t, e) {
          ...
          (this.prevMotionValues = (function (t, e, i) {
            for (let n in e) {
              let s = e[n],
                r = i[n];
              if (tQ(s)) t.addValue(n, s);
              else if (tQ(r)) t.addValue(n, t8(s, { owner: t }));
              else if (r !== s)
                if (t.hasValue(n)) {
                  let e = t.getValue(n);
        ...
        readValue(t, e) {
          ...
          return (
            null != i &&
              ("string" == typeof i && (Q(i) || tw(i))
                ? (i = parseFloat(i))
                : !et(i) && t$.test(e) && (i = tG(t, e)),
      ...
      class eP extends ew {
        constructor() {
          super(...arguments), (this.KeyframeResolver = tJ);
        }
      ...
      let eR = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
        ej = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
      ...
      let eY = (0, s.createContext)({}),
        ez = (0, s.createContext)({ strict: !1 }),
        eH = (0, s.createContext)({
      ...
      function e_(t, e, i) {
        for (let n in e) tQ(e[n]) || eC(n, i) || (t[n] = e[n]);
      }
      let eG = () => ({ ...eq(), attrs: {} }),
        eZ = new Set([
          "animate",
      ...
      try {
        !(function (t) {
          "function" == typeof t &&
            (eQ = (e) => (e.startsWith("on") ? !eJ(e) : t(e)));
        })(require("@emotion/is-prop-valid").default);
      } catch {}
      let e0 = (0, s.createContext)(null);
      function e1(t) {
        return tQ(t) ? t.get() : t;
      }
      let e5 = (t) => (e, i) => {
        ...
        e2 = e5({ scrapeMotionValuesFromProps: eD, createRenderState: eq }),
        e3 = e5({ scrapeMotionValuesFromProps: eI, createRenderState: eG }),
        e9 = Symbol.for("motionComponentSymbol");
      function e4(t) {
        return (
          t &&
          "object" == typeof t &&
      ...
      let e6 = "data-" + eR("framerAppearId"),
        e8 = (0, s.createContext)({}),
        e7 = el ? s.useLayoutEffect : s.useEffect;
      function it(t) {
        var e, i;
            ...
            (u = e.MeasureLayout),
              (p.visualElement = (function (t, e, i, n, r) {
                ...
                let { visualElement: u } = (0, s.useContext)(eX),
                  d = (0, s.useContext)(ez),
                  c = (0, s.useContext)(e0),
                  p = (0, s.useContext)(eH).reducedMotion,
                  m = (0, s.useRef)(null);
                (n = n || d.renderer),
                  !m.current &&
                    n &&
                  ...
                  l = (
                    e$(t)
                      ? function (t, e, i, n) {
                          ...
                          if (t.style) {
                            let e = {};
                            e_(e, t.style, t), (r.style = { ...e, ...r.style });
                          }
                          return r;
                        }
                      : function (t, e) {
      ...
      let iA = (t, e) => {
        ...
        return n.indexes.var.length === s.indexes.var.length &&
          ...
          ? (iT.has(t) && !s.values.length) || (iT.has(e) && !n.values.length)
            ? (function (t, e) {
                return iT.has(t)
                  ? (i) => (i <= 0 ? t : e)
                  : (i) => (i >= 1 ? e : t);
            ...
            if (!iF(t, iL) && iF(t, ij))
              if (t.visualDuration) {
                ...
                let i = (function ({
                  ...
                  let o = 1 - e;
                  (o = O(ik.minDamping, ik.maxDamping, o)),
                    (t = O(ik.minDuration, ik.maxDuration, iu(t))),
                    o < 1
                      ? ((s = (e) => {
                          let n = e * o,
                            s = n * t;
                          return 0.001 - ((n - i) / iR(e, o)) * Math.exp(-s);
                        }),
                        (r = (e) => {
                          let n = e * o * t,
        ...
        let s = (e) =>
          (function (t, e, i, n, s) {
            let r,
              ...
              a = 0;
            do
              (r = iI((o = e + (i - e) / 2), n, s) - t) > 0 ? (i = o) : (e = o);
      ...
      class ne extends i7 {
        ...
        initAnimation() {
          ...
          a !== i3 &&
            "number" != typeof o[0] &&
            ((this.mixKeyframes = il(nt, iM(o[0], o[1]))), (o = [0, 100]));
        ...
        tick(t, e = !1) {
          ...
          return (
            P && p !== iO && (T.value = i4(h, this.options, f, this.speed)),
            m && m(T.value),
            P && this.finish(),
            T
          );
          ...
          (this.animation = (function (
            ...
            (this.animation.onfinish = () => {
              if (((this.finishedTime = this.time), !s)) {
                let t = i4(n, this.options, o, this.speed);
      ...
      let nd = { anticipate: i_, backInOut: iq, circInOut: iJ };
      class nc extends nu {
        constructor(t) {
          !(function (t) {
        ...
        updateMotionValue(t) {
          ...
          let o = new ne({ ...r, autoplay: !1 }),
            a = ih(this.finishedTime ?? this.time);
        ...
        onKeyframesResolved(t, e, i, n) {
          ...
          (this.resolvedAt = t1.now()),
            !(function (t, e, i, n) {
              ...
              ((to.instantAnimations || !a) && h?.(i4(t, i, e)),
              (t[0] = t[t.length - 1]),
              io(i),
              (i.repeat = 0));
          let u = {
      ...
      let ny = (t) => null !== t,
        ...
        nb =
          ...
          (o) => {
            ...
            return a.isSync ? new ne(u) : new ng(u);
          };
              ...
              tu.update(() => {
                o &&
                  (function (t, e) {
                    ...
                    for (let e in (s = { ...s, ...i })) {
                      var r;
                      let i = is((r = s[e])) ? r[r.length - 1] || 0 : r;
                      t.hasValue(e)
                        ? t.getValue(e).set(i)
                        : t.addValue(e, t8(i));
                    }
                        ...
                        ...b.map((e) => {
                          ...
                          if (
                            ...
                            if (n.enteringChildren && s) {
                              ...
                              i.delay = nA(n.enteringChildren, t, e);
                            }
                          }
      ...
      let nG = ({ current: t }) => (t ? t.ownerDocument.defaultView : null),
        nZ = (t, e) => Math.abs(t - e);
      class nJ {
        constructor(
          t,
          ...
          let o = nQ(nN(t), this.transformPagePoint),
            { point: a } = o,
            { timestamp: l } = tc;
          this.history = [{ ...a, timestamp: l }];
          let { onSessionStart: h } = e;
          h && h(t, n1(o, this.history)),
        ...
        resolveConstraints() {
          ...
          t && e4(t)
            ...
            ? (this.constraints = (function (
                ...
                return { x: n2(t.x, i, s), y: n2(t.y, e, n) };
              })(i.layoutBox, t))
            : (this.constraints = !1),
          ...
          n_((t) => {
            ...
            if (e && !1 !== this.constraints) {
              ...
              n[t] = (function (t, e) {
                ...
                return (
                  s > n
                    ? (i = i2(e.min, e.max - n, t.min))
                    : n > s && (i = i2(t.min, t.max - s, e.min)),
                  O(0, 1, i)
                );
      ...
      let sn = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
      function ss(t, e) {
      ...
      class sa extends s.Component {
        componentDidMount() {
          let {
            ...
            { projection: s } = t;
          for (let t in sh) (eE[t] = sh[t]), x(t) && (eE[t].isCSSVariable = !0);
          s &&
      ...
      function sl(t) {
        ...
        return (0, eW.jsx)(sa, {
          ...t,
          layoutGroup: n,
          switchLayoutGroup: (0, s.useContext)(e8),
          isPresent: e,
          safeToRemove: i,
        });
      }
      ...
      function sd(t) {
        return su(t) && "ownerSVGElement" in t;
      }
      ...
      let sm = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
        sf = sm.length,
        sg = (t) => ("string" == typeof t ? parseFloat(t) : t),
        sy = (t) => "number" == typeof t || z.test(t);
      function sv(t, e) {
      ...
      function sM(t, e, [i, n, s], r, o) {
        !(function (t, e = 0, i = 1, n = 0.5, s, r = t, o = t) {
          ...
          t === r && (a -= e),
            (t.min = sA(t.min, e, i, a, s)),
            (t.max = sA(t.max, e, i, a, s));
        })(t, e[i], e[n], e[s], e.scale, r, o);
      }
      let sV = ["x", "scaleX", "originX"],
        sE = ["y", "scaleY", "originY"];
      function sC(t, e, i, n) {
        sM(t.x, e, sV, i ? i.x : void 0, n ? n.x : void 0),
          sM(t.y, e, sE, i ? i.y : void 0, n ? n.y : void 0);
      }
      function sD(t) {
        ...
        return class {
            ...
            (this.id = sN++),
              ...
              (this.updateProjection = () => {
                (this.projectionUpdateScheduled = !1),
                  tl.value &&
                    (sI.nodes =
                      sI.calculatedTargetDeltas =
                      sI.calculatedProjections =
                        0),
                  this.nodes.forEach(sH),
                  this.nodes.forEach(sJ),
                  this.nodes.forEach(sQ),
                  this.nodes.forEach(sX),
                  tl.addProjectionMetrics && tl.addProjectionMetrics(sI);
              }),
                ...
                this.addEventListener(
                  ...
                  ({
                    ...
                    let r =
                      ...
                      l = !this.targetLayout || !sL(this.targetLayout, n),
                      h = !e && i;
                    if (
          ...
          startUpdate() {
            !this.isUpdateBlocked() &&
              ((this.isUpdating = !0),
              this.nodes && this.nodes.forEach(s0),
              this.animationId++);
          }
          ...
          clearAllSnapshots() {
            this.nodes.forEach(sK), this.sharedNodes.forEach(s1);
          }
          ...
          resetTransform() {
            ...
            let t =
              ...
              e = this.projectionDelta && !sk(this.projectionDelta),
          ...
          measurePageBox() {
            ...
            if (!(this.scroll?.wasRoot || this.path.some(rt))) {
          ...
          removeElementScroll(t) {
            let e = ea();
            if ((sb(e, t), this.scroll?.wasRoot)) return e;
            for (let i = 0; i < this.path.length; i++) {
              ...
              n !== this.root &&
                s &&
                r.layoutScroll &&
                (s.wasRoot && sb(e, t), R(e.x, s.offset.x), R(e.y, s.offset.y));
            }
            return e;
          }
          applyTransform(t, e = !1) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              !e &&
                ...
                V(n.latestValues) && L(i, n.latestValues);
            }
            return V(this.latestValues) && L(i, this.latestValues), i;
          }
          removeTransform(t) {
            let e = ea();
            sb(e, t);
            ...
            return V(this.latestValues) && sC(e, this.latestValues), e;
          }
          setTargetDelta(t) {
            (this.targetDelta = t),
          ...
          resolveTargetDelta(t = !1) {
            ...
            if (this.layout && (n || s)) {
              ...
              if (this.relativeTarget || this.targetDelta) {
                ...
                tl.value && sI.calculatedTargetDeltas++;
              }
            }
          }
          ...
          calcProjection() {
              ...
              if (o) {
                ...
                for (let a = 0; a < o; a++) {
                  ...
                  (!o ||
                    ...
                    n && V(s.latestValues) && L(t, s.latestValues));
                }
            ...
            this.projectionDelta && this.prevProjectionDelta
              ...
              tl.value && sI.calculatedProjections++;
          }
          hide() {
            this.isVisible = !1;
          }
          ...
          resetSkewAndRotation() {
            ...
            if (
              ...
              return;
            let n = {};
            i.z && s$("z", t, n, this.animationValues);
            for (let e = 0; e < sU.length; e++)
              s$(`rotate${sU[e]}`, t, n, this.animationValues),
                s$(`skew${sU[e]}`, t, n, this.animationValues);
          ...
          applyProjectionStyles(t, e) {
            ...
            if (this.needsReset) {
              (this.needsReset = !1),
                (t.visibility = ""),
                (t.opacity = ""),
                (t.pointerEvents = e1(e?.pointerEvents) || ""),
            ...
            this.options.layoutId &&
              (t.pointerEvents =
                n === this ? e1(e?.pointerEvents) || "" : "none");
          }
          clearSnapshot() {
      ...
      function sz(t) {
        ...
        if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
          ...
          let a = er();
          r
            ? nH(a, t.applyTransform(n, !0), e.measuredBox)
            : nH(a, i, e.layoutBox);
          let l = !sk(o),
            h = !1;
          if (!t.resumeFrom) {
      ...
      let s9 = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        s4 = (t) =>
          "undefined" != typeof navigator &&
          navigator.userAgent &&
          navigator.userAgent.toLowerCase().includes(t),
        s6 = s4("applewebkit/") && !s4("chrome/") ? Math.round : tr;
      function s8(t) {
            ...
            (this.unmount = (function (t, e, i = {}) {
              let [n, s, r] = rs(t, i),
                o = (t) => {
                  ...
                  let r = (t) => {
                    rr(t) && (n(t), i.removeEventListener("pointerleave", r));
                  };
      ...
      let rh = (t, e) => !!e && (t === e || rh(t, e.parentElement)),
      ...
      let rm = (t, e) => {
        ...
        let n = rc(() => {
          ...
          i.addEventListener("keyup", t, e),
            i.addEventListener("blur", () => rp(i, "cancel"), e);
        });
          ...
          t &&
            (this.unmount = (function (t, e, i = {}) {
                  ...
                  let r = e(n, t),
                    o = (t, e) => {
                      window.removeEventListener("pointerup", a),
                        ...
                        rf(t) && "function" == typeof r && r(t, { success: e });
                    },
                    a = (t) => {
                      o(
                        t,
              ...
              return (
                n.forEach((t) => {
                  (i.useGlobalTarget ? window : t).addEventListener(
                    ...
                    su(t) &&
                      "offsetHeight" in t &&
                      (t.addEventListener("focus", (t) => rm(t, s)),
                      ru.has(t.tagName) ||
                        -1 !== t.tabIndex ||
              ...
              (t, e) => (
                ...
                (t, { success: e }) => rg(this.node, t, e ? "End" : "Cancel")
              ),
        ...
        startObserver() {
          ...
          return (function (t, e, i) {
            let n = (function ({ root: t, ...e }) {
              ...
              return (
                n[s] ||
                  (n[s] = new IntersectionObserver(rw, { root: t, ...e })),
                n[s]
              );
            })(e);
            return (
      ...
      let rS = (function (t, e) {
        if ("undefined" == typeof Proxy) return it;
        let i = new Map(),
          n = (i, n) => it(i, n, t, e);
      ...
      })(
        {
          ...
          hover: { Feature: ra },
          pan: { Feature: si },
          drag: { Feature: st, ProjectionNode: rn, MeasureLayout: sl },
          layout: { ProjectionNode: rn, MeasureLayout: sl },
        },
        (t, e) =>
