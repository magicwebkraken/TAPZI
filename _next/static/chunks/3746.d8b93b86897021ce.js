(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3746],
  {
    3746: (e, t, n) => {
      "use strict";
      n.d(t, { createCoinbaseWalletSDK: () => e2 });
      class r {
        constructor(e, t) {
      ...
      async function K(e, { iv: t, cipherText: n }) {
          ...
          return (
            ...
            (s !== this.chain &&
              ...
              null == (n = this.callback) ||
                n.call(this, "chainChanged", P(s.id))),
            !0)
          );
        }
      }
      ...
      class ev {
        constructor(e, t, n, r = !1) {
          (this.storage = e),
            (this.id = t),
            (this.secret = n),
            (this.key = (0, e_.My)((0, em.sc)(`${t}, ${n} WalletLink`))),
            (this._linked = !!r);
        }
        static create(e) {
      ...
      class eT {
        constructor() {
          (this.attached = !1), (this.redirectDialog = new eN());
        }
        attach() {
          if (this.attached)
            throw Error("Coinbase Wallet SDK UI is already attached");
      ...
      class eO {
        ...
        subscribe() {
          let e = ev.load(this.storage) || ev.create(this.storage),
            ...
            r = this.isMobileWeb ? new eT() : new eP();
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(r, (n) => {
              ...
              eO.accountRequestCallbackIds.add(r),
      ...
      let eU = "DefaultChainId",
        eW = "DefaultJsonRpcUrl";
      class eq {
        constructor(e) {
          (this._relay = null),
            (this._addresses = []),
            (this.metadata = e.metadata),
            (this._storage = new r("walletlink", eR)),
        ...
        get jsonRpcUrl() {
          var e;
          return null != (e = this._storage.getItem(eW)) ? e : void 0;
        }
        set jsonRpcUrl(e) {
          this._storage.setItem(eW, e);
        }
        ...
        async addEthereumChain(e) {
          ...
          let i = this.initializeRelay(),
            ...
            h = await i.addEthereumChain(s.toString(), a, c, o, l, u);
          if (eu(h)) return !1;
        ...
        _setAddresses(e, t) {
          ...
          JSON.stringify(r) !== JSON.stringify(this._addresses) &&
            ...
            this._storage.setItem(ec, r.join(" ")));
        }
        async request(e) {
          let t = e.params || [];
          switch (e.method) {
        ...
        getChainId() {
          ...
          return Number.parseInt(
            null != (e = this._storage.getItem(eU)) ? e : "1",
            10
          );
        }
      ...
      async function eK(e, t, n) {
        ...
        let r = new eq({ metadata: t, callback: n });
        e.postMessage({
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
        { checkCrossOriginOpenerPolicy: eG, getCrossOriginOpenerPolicy: e$ } =
          (() => {
            let e;
            return {
      ...
      class e0 extends eZ {
              ...
              switch (e.method) {
                case "eth_requestAccounts": {
                  let t = await this.requestSignerSelection(e),
                    n = this.initSigner(t);
                  await n.handshake(e), (this.signer = n), eB.setItem(eH, t);
                  break;
                }
                case "wallet_sendCalls": {
                ...
                case "wallet_getCallsStatus":
                  return en(e, "https://rpc.wallet.coinbase.com");
                case "net_version":
                  return 1;
                case "eth_chainId":
                  return P(1);
        ...
        initSigner(e) {
          ...
          switch (t) {
            ...
            case "walletlink":
              return new eq({ metadata: n, callback: s });
          }
        }
      }
      let e1 = { options: "all" };
      function e2(e) {
        new r("CBWSDK").setItem("VERSION", ee), eG();
        let t = {
          metadata: {
          ...
          preference: Object.assign(e1, null != (n = e.preference) ? n : {}),
        };
        var n,
          s = t.preference;
        if (s) {
              ...
              let c = (e, t, o) => {
                if (void 0 !== n[t])
                  return [
                    "bytes32",
                    null == o
                      ? "0x27e0f917d9df4d1febc7593bffb8bb09c63e44d600000000000000000000000000"
    ...
    19039: (e, t) => {
      ...
      t.add4L = k;
      let I = (e, t, n, r, s) => (t + n + r + s + ((e / 0x100000000) | 0)) | 0;
      t.add4H = I;
      let E = (e, t, n, r, s) =>
        (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0) + (s >>> 0);
      t.add5L = E;
      let C = (e, t, n, r, s, i) =>
        (t + n + r + s + i + ((e / 0x100000000) | 0)) | 0;
      (t.add5H = C),
        (t.default = {
          fromBig: s,
          split: i,
      ...
      function d(e, t) {
        ...
        for (var n, o, l = [], u = 0; u < e.length; u++) {
          var d = i(e[u]),
            h = t[u];
          if ("bytes" === d) l.push(h);
          else if ("string" === d) l.push(new r(h, "utf8"));
          else if ("bool" === d) l.push(new r(h ? "01" : "00", "hex"));
          else if ("address" === d) l.push(s.setLength(h, 20));
    ...
    64582: (e, t, n) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.kdfInputToBytes = function (e) {
          return "string" == typeof e && (e = f(e)), a(e), e;
        }),
    ...
    66117: (e, t, n) => {
      ...
      function M(e) {
        ((!e.__d && (e.__d = !0) && o.push(e) && !A.__r++) ||
          l != s.debounceRendering) &&
          ((l = s.debounceRendering) || c)(A);
      }
      function A() {
        for (var e, t, n, r, i, a, l = 1; o.length; )
          o.length > l && o.sort(u),
            (e = o.shift()),
            (l = o.length),
            e.__d &&
      ...
      function L(e, t, n, r, i, a, o, l, c, u, d) {
        var h,
          p,
          f,
          g,
                ...
                null != (l = n[a]) &&
                  ...
                  (function e(t, n, r) {
                    ...
                    if (
                      ...
                      (i = t.ref) &&
                        ((i.current && i.current != t.__e) || O(i, null, n)),
                      null != (i = t.__c))
                    ) {
      ...
      function R(e, t, n, i, a, o, l, c, u, d) {
        var h,
          p,
          f,
          g,
        ...
        e: if ("function" == typeof W)
          try {
            ...
            (p.state = p.__s),
              ...
              (c = L(e, b(O) ? O : [O], t, n, i, a, o, l, c, u, d)),
              (p.base = t.__e),
              (t.__u &= -161),
          ...
          null == o && t.__v == n.__v
            ...
            : (c = t.__e =
                (function (e, t, n, i, a, o, l, c, u) {
                  ...
                  return e;
                })(n.__e, t, n, i, a, o, l, u, d));
        return (h = s.diffed) && h(t), 128 & t.__u ? void 0 : c;
      }
      function T(e, t, n) {
      ...
      function q(e, t, n) {
        ...
        return (
          ...
          I(e.type, l, s || e.key, i || e.ref, null)
        );
      }
      function H(e) {
        function t(e) {
    ...
    91034: (e, t, n) => {
      ...
      class w extends s.Hash {
        ...
        update(e) {
          ...
          let { blockLen: t, state: n } = this,
            r = e.length;
          for (let s = 0; s < r; ) {
            let i = Math.min(t - this.pos, r - s);
            for (let t = 0; t < i; t++) n[this.pos++] ^= e[s++];
      ...
      t.Keccak = w;
      let v = (e, t, n) => (0, s.createHasher)(() => new w(t, e, n));
